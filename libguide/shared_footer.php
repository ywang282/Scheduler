<footer class="container s-lib-side-borders" role="contentinfo">
  <div class="row footer-info">
    ...
    <div class="col-md-3 col-sm-3 col-xs-12" role="region" aria-label="contact us">
      <div class="dropdown" aria-labelledby="address">
        <a href="#" class="dropdown-toggle footer-link" data-toggle="dropdown" aria-label="contact us"><span class="footerheading">Contact Us:<b class="caret"></b></span></a>
    ...
    <div class="col-md-3 col-sm-3 col-xs-12" role="region" aria-label="information for">  
      <span class="footerheading">Information for:</span>
      <div class="row">
        <div class="col-md-6"> 
    ...
    <div class="col-md-3 col-sm-3 col-xs-12" id="vertical" role="region" aria-label="about the site">
      ...
      <div class="footer-block-top-space">
        <a href="http://www.library.illinois.edu/doc/" aria-label="Federal Depository Library Program website link"><img src="http://www.library.illinois.edu/shared_content/assets/images/fdlp_logo.png" alt="Federal Depository Library Program Logo"></a>
      </div>
    </div> 
  </div>
  <div class="row lg-copyright-footer">
    <div class="col-md-12 copyright-footer" aria-label="university library copyright info">
      <p><a href="http://illinois.edu" aria-label="University of Illinois website link"><img src="http://www.library.illinois.edu/shared_content/assets/images/illinois_wordmark_footer.png" alt="University of Illinois Logo" /></a></p>
