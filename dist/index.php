...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/style-2ca177decb.css"> 
...
<!--[if lte IE 7]>
      ...
      <div class="container">
        <nav id="ui-lib-global-nav" class="global-nav-menu row">
          ...
          <div id="ui-lib-global-menu" class="menu-top-level-menu-container">
            <ul id="menu-global" class="nav navbar-nav">
              <li class="menu-item dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">About <span class="caret"></span></a>
                <ul role="menu" class=" dropdown-menu">
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/people/" role="menuitem" tabindex="-1">Employee Directory</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/people/directory.html" role="menuitem" tabindex="-1">Departmental Directory</a></li>
                  <li class="menu-item" role="presentation"><a href="http://illinois.edu/calendar/list/4092?cal=20160118&amp;skinId=1977" role="menuitem" tabindex="-1">Events &amp; Workshops</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/administration/human/positions/employment.html" role="menuitem" tabindex="-1">Library Employment</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/geninfo/history.html" role="menuitem" tabindex="-1">About Our Collections</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/administration/services/policies/" role="menuitem" tabindex="-1">Policies</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/friends/make-a-gift/" role="menuitem" tabindex="-1">Make a Gift</a></li>
                  <li class="menu-item" role="presentation"><a title="More about the library" href="http://www.library.illinois.edu/about/" role="menuitem" tabindex="-1"><span class="glyphicon More about the library"></span>&nbsp;MORE</a></li>
                </ul>
              </li>
              <li class="menu-item"><a href="http://www.library.illinois.edu/library-hours/">Libraries &amp; Hours</a></li>
              <li class="menu-item dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">Using the Library <span class="caret"></span></a>
                <ul role="menu" class=" dropdown-menu">
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/circ/policies/Policies.html#account" role="menuitem" tabindex="-1">Setup &amp; Use My Account</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/#roomresli" role="menuitem" tabindex="-1">Study Room Reservations</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/services/librarycomputing.html" role="menuitem" tabindex="-1">Print, Copy, Scan</a></li>
                  <li class="menu-item" role="presentation"><a href="http://www.library.illinois.edu/it/helpdesk/howto/vpn.html" role="menuitem" tabindex="-1">Connect From Off-Campus</a></li>
                  <li class="menu-item" role="presentation"><a title="More about using the library" href="http://www.library.illinois.edu/using/" role="menuitem" tabindex="-1"><span class="glyphicon More about using the library"></span>&nbsp;MORE</a></li>
                </ul>
              </li>
              ...
              <li class="menu-item dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">Search Tools <span class="caret"></span></a>
                <ul role="menu" class=" dropdown-menu">
                  <li class="menu-item" role="presentation"><a href="http://search.grainger.illinois.edu/searchaid2/searchassist.asp" role="menuitem" tabindex="-1">Easy Search</a></li>
                  <li class="menu-item" role="presentation"><a href="http://vufind.carli.illinois.edu/vf-uiu/" role="menuitem" tabindex="-1">Library Catalog</a></li>
                  <li class="menu-item" role="presentation"><a href="https://i-share.carli.illinois.edu/uiu/cgi-bin/Pwebrecon.cgi?DB=local&amp;PAGE=rbSearch" role="menuitem" tabindex="-1">Course Reserves</a></li>
                  <li class="menu-item" role="presentation"><a href="http://sfx.carli.illinois.edu/sfxuiu/az" role="menuitem" tabindex="-1">Online Journals</a></li>
                  <li class="menu-item" role="presentation"><a href="http://search.grainger.uiuc.edu/linker/" role="menuitem" tabindex="-1">Article Locator</a></li>
                  <li class="menu-item" role="presentation"><a href="http://guides.library.illinois.edu/az.php" role="menuitem" tabindex="-1">Databases (A-Z List)</a></li>
                  <li class="menu-item" role="presentation"><a title="More about search tools" href="http://www.library.illinois.edu/search-tools/" role="menuitem" tabindex="-1"><span class="glyphicon More about search tools"></span>&nbsp;MORE</a></li>
                </ul>
              </li>
            </ul>
          </div>
                ...
                <div class="col-sm-6 col-xs-10">
                  ...
                  <div class="table-row">
                    <div class="table-cell banner-image-imark-div">
                      <a href="http://illinois.edu"><img class="img-responsive col-xs-12 banner-image-imark" alt="University of Illinois I-Mark" src="./assets/images/imark.png"></a>
                    </div>
                    <div class="table-cell banner-table-spacer">
                    </div>
                    <div class="table-cell banner-image-library-div hidden-xs">
                      <a href="http://www.library.illinois.edu"><img class="img-responsive col-xs-12 banner-image-library" alt="University Library, University of Illinois at Urbana-Champaign" src="./assets/images/university_libraries_wordmark.png" ></a>
                    </div>
                    <div class="table-cell banner-image-library-div visible-xs">
                      <a href="http://www.library.illinois.edu"><img class="img-responsive col-xs-12 banner-image-library banner-mobile-img" alt="Library" src="./assets/images/library_wordmark.png" ></a>
                    </div>
                  </div>
                </div>
                ...
                <div id="dynamictabs">
                  <ul class="accordion-tabs-minimal dynamictabs" role="tablist">
                                  ...
                                  <div id="library-hours-header">
                                    <div class="row">
                                      ...
                                      <div class="col-md-6 vertical-center" id="library_search_additional_links_div"> 
                                        <a href="hours.php">Weekly Hours View</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                    ...
                    <li class="tab-header-and-content" role="presentation">
                      ...
                      <div class="tab-content-bourbon">
                        <div class=" dynamic-tab-pane" id="help">    
                          <div class="dynamic-panel-body">
                            <div class="container-fluid">
                              <div class="row">
                                <div class="col-sm-12">
                    ...
                    <li class="tab-header-and-content" role="presentation">
                      ...
                      <div class="tab-content-bourbon">
                       <div class=" dynamic-tab-pane" id="tech">
                        <div class="dynamic-panel-body">
                          <div class="container-fluid">
                            <div class="row">
                              <div class="col-sm-12">
                      ...
                      <li class="tab-header-and-content" role="presentation">
                          ...
                          <div class="tab-content-bourbon">
                              <div class="dynamic-tab-pane" id="roomres">
                                  <div class="dynamic-panel-body">
                                      <div class="container-fluid">
                                          <div class="row">
                                              <div class="col-sm-12">
                    ...
                    <li class="tab-header-and-content" role="presentation">
                      ...
                      <div class="tab-content-bourbon">
                        <div class="dynamic-tab-pane" id="news">
                          <div class="dynamic-panel-body">
                            <div class="container-fluid">
                              <div class="row">
                                <div class="col-sm-12">
  ...
  <script type="text/javascript" src="./assets/js/script-6af815ef31.js"></script>
